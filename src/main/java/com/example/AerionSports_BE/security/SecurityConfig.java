    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/public/online-orders/**", "/api/public/online-orders/**").permitAll()
                        .requestMatchers("/dang-ky-nhan-vien", "/dang-ky-khach-hang", "/quen-mat-khau").permitAll()
                        ...
                        .requestMatchers(
                                ...
                                "/ban-hang", "/ban-hang/**",          // 🌟 Cho phép NV bán hàng
                                "/hoa-don", "/hoa-don/**",            // 🌟 Cho phép NV xem/tạo hoá đơn
                                "/api/san-pham/**",
                                "/api/thong-ke/**",
                        ...
                        // =========================================================
                        // 🔒 NHÓM 3: CHỈ ADMIN & QUẢN LÝ MỚI ĐƯỢC VÀO
                        // =========================================================
                        .requestMatchers(
                                "/thong-ke",
                                "/nhan-vien", "/nhan-vien/**",
