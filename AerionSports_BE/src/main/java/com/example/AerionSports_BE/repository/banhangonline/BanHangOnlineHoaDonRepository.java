...
public interface BanHangOnlineHoaDonRepository extends JpaRepository<HoaDon, Integer> {
    ...
    LEFT JOIN FETCH ct.chiTietSanPham spct
    WHERE hd.maHoaDon = :maHoaDon
    """)
    Optional<HoaDon> findByMaHoaDonWithChiTiet(@Param("maHoaDon") String maHoaDon);

    List<HoaDon> findByLoaiHoaDonAndTrangThaiAndNgayTaoBefore(Integer loaiHoaDon, Integer trangThai, LocalDateTime ngayTao);
