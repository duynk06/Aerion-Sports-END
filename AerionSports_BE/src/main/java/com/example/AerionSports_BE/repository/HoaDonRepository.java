...
""")
    ...
    List<HoaDon> findByTrangThaiAndNhanVien_Id(Integer trangThai, Integer idNhanVien);
    long countByTrangThaiAndNhanVien_Id(Integer trangThai, Integer idNhanVien);
}
